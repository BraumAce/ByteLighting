---
url: >-
  https://blog.bytelighting.cn/computer/backend/framework/middleware/springboot-minio-integration.md
---
# SpringBoot 整合 MinIO

通过 SpringBoot 集成 MinIO Java SDK，实现对象存储的 Bucket 和 Object 操作，包括依赖引入、配置、MinioClient 注册及常用 API 示例。
