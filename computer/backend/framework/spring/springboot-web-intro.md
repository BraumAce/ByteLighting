---
url: >-
  https://blog.bytelighting.cn/computer/backend/framework/spring/springboot-web-intro.md
---
# Web 入门

SpringBoot Web 开发入门，涵盖 HTTP 协议、请求参数接收、响应处理、三层架构与 IOC/DI 解耦。
...
| 请求方式 | 请求说明                                                     |
| :------: | :----------------------------------------------------------- |
| **GET**  | 获取资源。向特定的资源发出请求。例：http://www.baidu.com |
