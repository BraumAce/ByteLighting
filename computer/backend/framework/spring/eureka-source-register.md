---
url: >-
  https://blog.bytelighting.cn/computer/backend/framework/spring/eureka-source-register.md
---
# Eureka 源码 - 注册过程

Eureka Client 向 Server 注册的源码剖析，包括初始化配置、构造 EurekaClient（DiscoveryClient）、InstanceInfoReplicator 后台线程注册及 HTTP POST 请求发送流程。
