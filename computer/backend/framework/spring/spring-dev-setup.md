---
url: >-
  https://blog.bytelighting.cn/computer/backend/framework/spring/spring-dev-setup.md
---
# Spring 开发准备

Spring Boot 开发准备工作，涵盖 REST 风格 API 规范、统一响应结果、文件上传（本地存储与云存储）、配置文件（properties/yml）及常用注解详解。
