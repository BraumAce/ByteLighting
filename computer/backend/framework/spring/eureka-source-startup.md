---
url: >-
  https://blog.bytelighting.cn/computer/backend/framework/spring/eureka-source-startup.md
---
# Eureka 源码 - 启动过程

Eureka Server 启动过程的源码剖析，包括初始化环境、加载配置文件、构造实例信息管理器、初始化 eureka-client 及上下文等核心流程。
