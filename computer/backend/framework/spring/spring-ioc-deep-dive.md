---
url: >-
  https://blog.bytelighting.cn/computer/backend/framework/spring/spring-ioc-deep-dive.md
---
# 深入理解 IoC

Spring IoC 容器的核心概念、注入形式以及各组件体系（Resource、BeanFactory、BeanDefinition、ApplicationContext 等）的深度解析。
