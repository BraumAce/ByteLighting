---
url: >-
  https://blog.bytelighting.cn/domains/backend/architecture/system-design/pattern/sofa-architecture-pattern.md
---
# SOFA 架构模式

SOFA（Simple Object-oriented and Flexible Architecture）是蚂蚁金服开源的基于 Spring Boot 的模块化研发框架。本文介绍 SOFABoot 功能、模块化开发方式及 SOFA 分层工程结构。
...
SOFABoot 开发文档：<https://www.sofastack.tech/projects/sofa-boot/modular-development/>
