---
url: 'https://blog.bytelighting.cn/domains/backend/databases/mysql-fundamentals.md'
---
# MySQL 基础知识

MySQL 基础知识全面梳理，涵盖 SQL 语法（DDL/DML/DQL）、多表设计与查询、事务、索引等核心内容。
...
案例：修改 qq 字段名为 qq\_num，字段类型 varchar(13)
