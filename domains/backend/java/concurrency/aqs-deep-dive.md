---
url: 'https://blog.bytelighting.cn/domains/backend/java/concurrency/aqs-deep-dive.md'
---
# 深入理解 AQS

本文通过源码分析 AbstractQueuedSynchronizer 的核心实现，包括同步队列的数据结构、独占锁与共享锁的获取和释放流程，以及可中断锁和超时等待机制。
