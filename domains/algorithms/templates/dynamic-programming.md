---
url: >-
  https://blog.bytelighting.cn/domains/algorithms/templates/dynamic-programming.md
---
# 动态规划

涵盖背包问题、线性DP、区间DP、计数类DP、数位统计DP、状态压缩DP、树形DP 等动态规划模板。
...
$dp\[0]\[i] = \sum\_{u=sons} max(dp\[1]\[u], dp\[0]\[u])$ 当前节点不选，那么子节点随意

$dp\[1]\[i] = \sum\_{u=sons} dp\[0]\[u] + happy\[i]$ 当前节点选，子节点不能选
