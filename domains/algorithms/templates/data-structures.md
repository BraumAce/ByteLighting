---
url: 'https://blog.bytelighting.cn/domains/algorithms/templates/data-structures.md'
---
# 数据结构

涵盖链表、栈、队列、KMP、Trie树、并查集、堆、哈希表、STL 以及常用库函数等数据结构模板。
...
性质：如果 $a\_x \geq a\_y, x < y$，那么 $a\_x$ 永远不会被输出，可以删掉。比如 $a\_3 \geq a\_5$，那么 $a\_3$ 永远不会被输出。
