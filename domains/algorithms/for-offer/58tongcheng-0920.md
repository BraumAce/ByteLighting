---
url: 'https://blog.bytelighting.cn/domains/algorithms/for-offer/58tongcheng-0920.md'
---
# 58同城笔试 - 0920
...
题目确保：$0 < start\_i < end\_i < start\_{i+1} < 10000$
...
尝试用数学的方法，通过计算 $C^m\_n$ 求解，但只能过 $54.44%$。
