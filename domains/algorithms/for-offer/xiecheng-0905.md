---
url: 'https://blog.bytelighting.cn/domains/algorithms/for-offer/xiecheng-0905.md'
---
# 携程笔试 - 0905
...
现在可以执行任意次修改，每次修改选择一个下标 $i(1 \le i \le n)$，令 $a\_i = a\_i - 1$，注意 $a\_i$ 不能为负数。最少执行多少次操作可以满足 $a$ 是一个好数组？

输入描述：\
第一行，输入 $n,k,sum$ $(1 \le k \le n \le 2×10^5, 1 \le sum \le 10^{13})$\
第二行输入 $n$ 个数 $a\_i$ $(0 \le a\_i \le 10^9)$
