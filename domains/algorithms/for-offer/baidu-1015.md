---
url: 'https://blog.bytelighting.cn/domains/algorithms/for-offer/baidu-1015.md'
---
# 百度笔试 - 1015
...
现在李华要对这块画布进行 $m$ 次染色，第 $i(1≤i≤m)$ 次染色将会把编号不大于 $x\_i$ 的位置染成 $i$ 号颜色，若某些位置被多次染色，则编号较大的颜色能完全覆盖编号较小的颜色。求出李华每完成一次染色后画布上的颜色种类数（包括 $0$ 号颜色）。
