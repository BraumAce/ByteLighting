---
url: 'https://blog.bytelighting.cn/domains/algorithms/for-offer/xiaoheihe-0907.md'
---
# 小黑盒笔试 - 0907
...
从起点开始, 每次你最多可以往右移动 $x$ 步（$1$～$x$ 任意步都可以）。比如你在位置 $1$, 如果往右移动 $x$ 步，下一个位置为 $x+1$。当你每次移动到某个格子的时候, 会收到伤害为 $T\_i$
