---
url: 'https://blog.bytelighting.cn/domains/blog/tools/ai-toolset.md'
---
# AI 工具集
...
项目地址：<https://github.com/regenrek/deepwiki-mcp>
...
## 5. LearnClaudeCode，学习 Claude Code 思想

* 地址：[learn-claude-code](https://mp.weixin.qq.com/s/0NAUXJ8pVt_dJXLVMNvRfQ)

项目主页：https://learn.shareai.run/zh/

关于 Claude Code 相关思想的分享学习路线。

## 4. 约束 AI 写代码，专治上下文腐败

* 地址：[get-shit-done](https://github.com/gsd-build/get-shit-done)

专门为 Claude Code、OpenCode、Gemini CLI、Codex、Copilot 和 Antigravity 等 AI 编程工具设计。

通过巧妙的上下文工程、XML 提示格式化、子代理编排和状态管理，让 AI 在整个开发过程中都能保持稳定、高质量的输出。
...
地址：<https://github.com/pogjester/company-research-agent>
...
地址：<https://github.com/The-Pocket/Tutorial-Codebase-Knowledge>
