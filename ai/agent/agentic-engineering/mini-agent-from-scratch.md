---
url: >-
  https://blog.bytelighting.cn/ai/agent/agentic-engineering/mini-agent-from-scratch.md
---
...
* **上线前一定要加 trace**。每一步的 messages、tool\_call、tool\_result 全部落日志或上 Micrometer + Zipkin / Jaeger，否则线上一翻车就是黑盒。
