...
<p align="center">
	<img src="/src/.vuepress/public/ByteLighting.png" alt="" style="zoom:50%; width:200px; height:auto;" align="center" />
</p>
<p align="center">
...
ByteLighting -- BraumAce's Blog，记录工程实践、知识沉淀与学习笔记。基于 VuePress 2 + [vuepress-theme-hope](https://theme-hope.vuejs.press/) 构建的以 Markdown 为中心的轻量级静态博客。

特点：
- 多样化 Markdown 拓展：自定义容器和语法拓展、集成图表、PDF阅读器、视频播放器...
- 订阅和分享：支持 Atom、JSON 和 RSS 格式的订阅流、集成各大主流媒体分享功能
- 评论系统：集成 GitHub 应用 Giscus 评论
- 客户端搜索：基于 SlimSearch 的全文索引、分词索引
