...
source: raw/legacy/computer/language/java/JUC 并发编程/4. 彻底理解synchronized.md
status: published
...
本文深入剖析 synchronized 关键字的实现原理，包括对象锁（monitor）机制、happens-before 关系、内存语义，以及 JDK 1.6 引入的偏向锁、轻量级锁等优化策略。
...
在 java 代码中 `synchronized` 可使用在代码块和方法中，根据 Synchronized 用的位置可以有这些使用场景：

![](https://cloud.bytelighting.cn/f/2XrsZ/4.1%20synchronized%E7%9A%84%E4%BD%BF%E7%94%A8%E5%9C%BA%E6%99%AF.png)
...
![SynchronizedDemo.class](https://cloud.bytelighting.cn/f/DP2SX/4.2%20synchronizedDemo.class.png)
...
![](https://cloud.bytelighting.cn/f/LYPCl/4.3%20%E5%AF%B9%E8%B1%A1%EF%BC%8C%E5%AF%B9%E8%B1%A1%E7%9B%91%E8%A7%86%E5%99%A8%EF%BC%8C%E5%90%8C%E6%AD%A5%E9%98%9F%E5%88%97%E5%92%8C%E7%BA%BF%E7%A8%8B%E7%8A%B6%E6%80%81%E7%9A%84%E5%85%B3%E7%B3%BB.png)
...
![](https://cloud.bytelighting.cn/f/WKJt7/4.4%20synchronized%E7%9A%84happens-before%E5%85%B3%E7%B3%BB.png)
...
![](https://cloud.bytelighting.cn/f/lldfD/4.5%20%E7%BA%BF%E7%A8%8BA%E5%86%99%E5%85%B1%E4%BA%AB%E5%8F%98%E9%87%8F.png)

从上图可以看出，线程 A 会首先先从主内存中读取共享变量 `a = 0` 的值然后将该变量拷贝到自己的本地内存，进行加一操作后，再将该值刷新到主内存，整个过程即为 线程 A 加锁 --> 执行临界区代码 --> 释放锁相对应的内存语义。

![](https://cloud.bytelighting.cn/f/E9wuY/4.6%20%E7%BA%BF%E7%A8%8BB%E8%AF%BB%E5%85%B1%E4%BA%AB%E5%8F%98%E9%87%8F.png)
...
![Mark Word 存储结构](https://cloud.bytelighting.cn/f/Nlnsv/4.7%20Mark%20Word%E5%AD%98%E5%82%A8%E7%BB%93%E6%9E%84.png)
...
![Mark Word 状态变化](https://cloud.bytelighting.cn/f/Xgju0/4.8%20Mark%20Word%E7%8A%B6%E6%80%81%E5%8F%98%E5%8C%96.png)
...
![偏向锁撤销流程](https://cloud.bytelighting.cn/f/xXGFl/4.9%20%E5%81%8F%E5%90%91%E9%94%81%E6%92%A4%E9%94%80%E6%B5%81%E7%A8%8B.png)
...
![](https://cloud.bytelighting.cn/f/vEkCE/4.10%20%E5%81%8F%E5%90%91%E9%94%81%E8%8E%B7%E5%8F%96%E5%92%8C%E6%92%A4%E9%94%80%E6%B5%81%E7%A8%8B.png)
...
![](https://cloud.bytelighting.cn/f/AzPFE/4.11%20%E8%BD%BB%E9%87%8F%E7%BA%A7%E9%94%81%E5%8A%A0%E9%94%81%E8%A7%A3%E9%94%81%E4%BB%A5%E5%8F%8A%E9%94%81%E8%86%A8%E8%83%80.png)
...
![](https://cloud.bytelighting.cn/f/y88C1/4.12%20%E5%90%84%E7%A7%8D%E9%94%81%E7%9A%84%E5%AF%B9%E6%AF%94.png)
